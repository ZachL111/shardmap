"""Regression checks for the shardmap casebook."""
...
from casebook.harness import assert_expected, shardmap_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(shardmap_summary(), assert_expected())
